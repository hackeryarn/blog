...
keywords:
  ...
  - returns
---
In [Part 1](https://hackeryarn.com/post/django-returns-1/) of this
series, we looked at how to setup a python project with types, setup our
project, and used some basic types.
...
Let\'s run our initial migrations and get rid of the error that we
ignored in the first part.
...
Before we can apply these migrations, we need to let Django know about
our Polls app.
...
In the meantime, I encourage you to go through at least all the shell
examples in [the official
tutorial](https://docs.djangoproject.com/en/4.0/intro/tutorial02/) and
